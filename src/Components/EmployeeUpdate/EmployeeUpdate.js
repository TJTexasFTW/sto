...
class Employee_Update_Delete extends Component {
    ...
    render() {
        ...
        return(
            ...
            <p className='inputLabel'>Current Name:  <input className='inputBox' placeholder = "FLast"/></p>
            <p className='inputLabel'>Revised Name:  <input className='inputBox' placeholder = "FLast"/></p>
            <p className='inputLabel'>Current Initials:  <input className='inputBox' placeholder = "Initials"/></p>
            <p className='inputLabel'>Revised Initials:  <input className='inputBox' placeholder = "Initials"/></p>
